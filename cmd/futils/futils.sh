...
echo
echo
echo -e "[Synopsis]:ta collection of file/folder operation helpers"
echo
echo -e " r-md5tttRecursively generate md5 hashes in target dirs ."
echo -e " [flag|optional]t--dupes tonly list duplicates.[DEFAULT: 'false']"
echo -e " [flag|optional]t--output <arg> tTarget to store the list in.[DEFAULT: 'mdsums.list']"
echo -e " [flag(s)|optional]t--dir <arg> tDirectories to search.[DEFAULT: '$PWD']"
echo
echo -e " deduptttRecursively finds duplicate files in directory by comparing them"
echo -e "tttwith files in an origin directory ."
echo -e " tttIt does not delete duplicates in origin directory"
echo -e " [flag|optional]t--output <arg> tTarget to store the list of deleted files in."
echo -e " [flag]tt--origin <arg> torigin directory."
echo -e " [flag(s)]tt--target <arg> tdirectories to be deduplicated."
echo
echo
echo "Optional Flags:"
echo
